...
void AntiThetic::ResetDimensionality(unsigned long NewaDimensionality) {
	RandomBase::ResetDimensionality(NewaDimensionality);
	NextVariates.resize(NewaDimensionality);
	InnerGenerator->ResetDimensionality(NewaDimensionality);
}
